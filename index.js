...
const uri = `mongodb+srv://reservation:${process.env.DB_PASS}@cluster0.fsxpjfg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    const bookingsCollection = client.db("reservation").collection("bookings");
    // auth related api
